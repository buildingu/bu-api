            ...
            <table class="tables-fixed w-full">
                <thead>
                    <tr class="bg-gray-100 font-bold">
                        ...
                        <th class="border px-4 py-2 w-20">State</th>
                ...
                <tbody>
                    @if (sizeof($cities) == 0)
                        <tr>
                            <td class="border px-4 py-2 text-center" colspan="4">No cities found.</td>
                        </tr>
                    @else
                        @foreach($cities as $city)
                            <tr class="class-center">
                                <td class="border px-4 py-2 text-center">{{ $city->id }}</td>
                                <td class="border px-4 py-2 text-center">{{ $city->name }}</td>        
                                <td class="border px-4 py-2 text-center">{{ $city->state_id }}</td>        
