            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex sm:items-center">
                    <x-jet-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            <x-jet-dropdown-link href="{{ route('countries') }}">
                                {{ __('Countries') }}
                            </x-jet-dropdown-link>
                            <x-jet-dropdown-link href="{{ route('states') }}">
                                {{ __('States') }}
                            </x-jet-dropdown-link>
                            <x-jet-dropdown-link href="{{ route('cities') }}">
                                {{ __('Cities') }}
                            </x-jet-dropdown-link>
                        </x-slot>
                    </x-jet-dropdown>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="{{ route('tag_posts') }}" :active="request()->routeIs('tag_posts')">
                        {{ __('Tag Posts') }}
                    </x-jet-nav-link>
                </div>
            </div>
